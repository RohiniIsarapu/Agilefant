...
DailyWorkTasksWithoutStoryController.columnNames =
  [ "prio", "name", "state", "billable", "context", "detailedContext", "responsibles", "el", "es", "actions", "details", "buttons"];
...
DailyWorkTasksWithoutStoryController.prototype._addColumnConfigs = function(config) {
  ...
  //added by Fall2017 team
  config.addColumnConfiguration(DailyWorkTasksWithoutStoryController.columnIndices.billable, TasksWithoutStoryController.columnConfig.billable);
