...
(function() {
  ...
  config.addColumnConfiguration(TaskController.columnIndices.billable, {
	    minWidth : 80,
	    autoScale : true,
	    cssClass : 'task-row',
	    title : "Billable",
	    headerTooltip : 'Task billabile',
	    get : TaskModel.prototype.getBillable,
	    editable : true,
	    edit : {
	      editor : "Selection",
	      set : TaskModel.prototype.setBillable,
	      items : DynamicsDecorators.billableOptions
	    }
	  });
