...
TaskModel.prototype.getBillable = function() {
	return this.currentData.billable;
};
TaskModel.prototype.setBillable = function(billable) {
	this.currentData.billable = billable;
};
