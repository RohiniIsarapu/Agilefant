...
public class DatabaseInitializer implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        try {
            jdbc.update("INSERT INTO backlogs (description, name, parent_id, backlogtype,billable) VALUES (?, ?, ?, ?,?)",
            ...
            jdbc.update("INSERT INTO backlogs (description, name, parent_id, backlogSize, baselineLoad, endDate, rank, startDate, status, backlogtype,billable) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)",
            ...
            jdbc.update("INSERT INTO backlogs (description, name, parent_id, backlogSize, baselineLoad, endDate, readonlyToken, startDate, backlogtype,billable) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?,?)",
